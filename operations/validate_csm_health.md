...
This section can be run on any NCN or the PIT node, provided the `docs-csm` RPM is installed.
For details on installing the `docs-csm` RPM, see [Check for Latest Documentation](../update_product_stream/index.md#documentation).
